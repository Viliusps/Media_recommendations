...
df = pd.read_csv('SongMovies/SongMovies1k.csv')
...
X_train, X_test, y_train_numerical, y_test_numerical = train_test_split(X, y_numerical, test_size=0.8, random_state=42)
#_, _, y_train_genre, y_test_genre = train_test_split(X, y_genre, test_size=0.8, random_state=42) # Ensure matching indices
...
y_train = y_train_numerical_scaled
y_test = y_test_numerical_scaled
